              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Select onChange={(e) => setState({ ...state, sub_cat: e.target.value })} aria-label="Default select example">
                    ...
                    <option selected={state.sub_cat=='Cinema/Video'} value="Cinema/Video">Cinema/Video</option>
                    <option selected={state.sub_cat=='Pre Wedding Shoot'} value='Pre Wedding Shoot'>Pre Wedding Shoot</option>
                  </Form.Select>
                </Form.Group>
