              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Select  onChange={(e) => setState({ ...state, sub_cat: e.target.value })} aria-label="Default select example">
                    ...
                    <option selected={state.sub_cat=='Kanjeevaram Sarees'} value="Kanjeevaram Sarees">Kanjeevaram Sarees</option>
                    <option selected={state.sub_cat=='Silk Sarees'} value='Silk Sarees'>Silk Sarees</option>
                    <option selected={state.sub_cat=='Bridal Lehengas'} value="Bridal Lehengas">Bridal Lehengas</option>
                    <option selected={state.sub_cat=='Cocktail Gowns'} value="Cocktail Gowns">Cocktail Gowns</option>
                  </Form.Select>
